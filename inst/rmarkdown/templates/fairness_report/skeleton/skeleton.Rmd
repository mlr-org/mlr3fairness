...
The background of this task is `background`.
In this fairness report, we investigate the fairness of this task:
...
We would like to introduce model `models` for this task.
...
From the above reporting metrics and benchmark results. We could see there are some potential fairness problems.
