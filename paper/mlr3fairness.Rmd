...
<!-- tightly integrated into the \CRANpkg{mlr3} [@mlr3] ecosystem of packages for ML in R.-->
...
We then briefly introduce the \CRANpkg{mlr3} package before introducing the functionality
