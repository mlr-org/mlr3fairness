...
Furthermore, practitioners need not only take into account the model itself, but also the data used to train the algorithm and the process behind collecting and labelling of such data, including possible feedback loops emerging from potentially biased models.
...
If the labels $Y$ arise from a biased *label generating process*, such as past loan decisions, there is little hope of obtaining fair outcomes even if fairness metrics indicate this.
