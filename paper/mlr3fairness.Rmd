...
In this Section we will briefly introduce the main concepts for quantifying fairness and correcting for bias in models.
...
Column `"race"` is set as binary protected attribute with levels `"Caucasian"` and `"African American"`.
...
The following Subsections give a rough overview over the implemented functionality.
...
Plotting the prediction density or comparing the measures graphically often gives more insights:
...
A `AutoTuner` requires a specific metric to tune for.
