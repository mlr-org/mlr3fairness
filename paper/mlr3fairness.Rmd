...
A more in-depth treatment of metrics is given in (@fairmlbook, @saleiro2018aequitas, @kim2020fact, @mehrabi, and @wachter-vlr2020).
...
For example, we can see that African-American defendants are more often assigned low probabilities of not re-offending (predicted class `0`).
