...
>>>>>>> 30fb7e2cc5082407650f2a54684bbd99f74632db
...
=======
This intuitively requires, e.g. in the case of university admission, that independent of the protected attribute, qualified individuals have the same chance to be accepted, and unqualified individuals have the same chance to be rejected.
>>>>>>> 30fb7e2cc5082407650f2a54684bbd99f74632db
...
As such, e.g. in the presence of historical injustices *bias-preserving* metrics maintain the status quo - existing disparities e.g. in base rates are not detected.
*Bias-transforming* methods, in contrast do not depend on the labels and are therefore tailored to detect such labels in practice. 
They can help detecting biases arising from different base-rates across populations, arising e.g. from biases in the labels or as a consequence of structural discrimination.
Deciding which metrics to use constitutes a value judgement and requires careful assessment of the societal context a decision making system is deployed in.
Instead of recommending concrete fairness metrics, we want to point the reader to a variety of ressources that discuss the choice of fairness notion in more detail.
