---
title: Datasheet for dataset "add dataset name here"
author:
  - name: First Author
    affil: 1
  - name: Second Author
...
affiliation:
  - num: 1
    address: Planet Earth, Milky Way
  - num: 2
    address: Planet Earth, Milky Way
column_numbers: 4
poster_height: 95%
poster_width: 96%
primary_colour: "#235187"
output: 
...
Questions from the [Datasheets for Datasets](https://arxiv.org/abs/1803.09010) paper, v7. (@datasheets)
