...
In this vignette, users could see examples on how to create the most common fairness measures. Moreover, users could see how to customize their fairness measures using MeasureFairness classes.
