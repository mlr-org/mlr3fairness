...
* [**Fairness Measures:**](#metrics) Audit algorithmms for fairness using a variety of fairness criteria. This also allows for designing custom criteria.

* [**Fairness Visualizations:**](#viz) Diagnose fairness problems through visualizations.

* [**Debiasing Methods:**](#debiasing) Correct fairness problems in three lines of code.

* [**Fairness Report:**](#reports) Obtain a report regarding an algorithm's fairness. (Under development)
...
### Model Cards & Datasheets {#reports}
