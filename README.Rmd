...
```{r, echo = FALSE}
tab = rowwise_table(~key, ~package, ~reference,
...
- The [fairml](https://cran.r-project.org/web/packages/fairml/index.html) package contains methods for learning de-biased regression and classification models.
